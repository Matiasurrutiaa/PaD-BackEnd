"""
Django settings for PoliticaAlDia project.
...
SECRET_KEY = 'django-insecure-ne0lpup=^z)59mlr8fy*=o7ta+=^2+pb^p7bq(li=lft4ox(&-'
...
ROOT_URLCONF = 'PoliticaAlDia.urls'
...
WSGI_APPLICATION = 'PoliticaAlDia.wsgi.application'
